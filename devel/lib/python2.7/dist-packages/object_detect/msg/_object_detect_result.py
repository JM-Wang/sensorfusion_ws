...
"""autogenerated by genpy from object_detect/object_detect_result.msg. Do not edit."""
import sys
...
class object_detect_result(genpy.Message):
  _md5sum = "de558ca67480455c677f81e5d9870972"
  _type = "object_detect/object_detect_result"
...
uint32 stride  # stride of given dimension"""
  ...
  _slot_types = ['std_msgs/Header','std_msgs/Int32MultiArray']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(object_detect_result, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.result is None:
        self.result = std_msgs.msg.Int32MultiArray()
    else:
      self.header = std_msgs.msg.Header()
      self.result = std_msgs.msg.Int32MultiArray()
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.result.data = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
